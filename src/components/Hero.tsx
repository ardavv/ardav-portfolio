...
const Hero = () => {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center pt-16 bg-gradient-to-b from-white to-portfolio-purple/5"
    >
        ...
        <div className="flex flex-col-reverse md:flex-row items-center">
          <div className="md:w-1/2 animate-fade-in">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Halo, Saya{" "}
              <span className="gradient-text">Arya Davi Sulaiman</span>
            </h1>
            <p className="text-lg text-gray-700 mb-8 max-w-lg">
              Mahasiswa semester 4 jurusan Informatika Fakultas Ilmu Komputer,
              dengan pengalaman di bidang Web Development.
            </p>
            <div className="flex flex-wrap gap-4">
              ...
              <Button
                variant="outline"
                className="border-portfolio-purple text-portfolio-darkPurple hover:bg-portfolio-purple/10"
              >
          ...
          <div
            className="md:w-1/2 mb-8 md:mb-0 flex justify-center animate-fade-in"
