        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-8">
          <div>
            ...
            <p className="text-gray-300 mb-6">
              Mahasiswa Informatika dengan keahlian dalam pengembangan web
              modern menggunakan React, Next.js, dan Supabase.
            </p>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-2">aryadavi276@gmail.com</p>
